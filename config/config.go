...
type General struct {
	...
	DisableTracker bool         `json:"notrack"`
}
...
type RawConfig struct {
	...
	DisableTracker     bool         `yaml:"notrack"`
...
func parseProxies(cfg *RawConfig) (proxies map[string]C.Proxy, providersMap map[string]provider.ProxyProvider, err error) {
	...
	proxies["DIRECT"] = outbound.NewProxy(outbound.NewDirect(&outbound.DirectOption{Name: "DIRECT", NoTrack: cfg.DisableTracker}))
